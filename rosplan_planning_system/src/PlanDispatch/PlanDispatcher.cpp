...
namespace KCL_rosplan {
	 ...
	 */
    bool PlanDispatcher::checkStartPreconditions(rosplan_dispatch_msgs::ActionDispatch msg) {
    ...
    bool PlanDispatcher::checkEndPreconditions(rosplan_dispatch_msgs::ActionDispatch msg) {
        ...
        // iterate through conditions
        std::vector<rosplan_knowledge_msgs::DomainFormula>::iterator cit = op.at_end_simple_condition.begin();
