            ...
            std::map<std::string, std::string> &ground_dictionary)
{
    ...
    // and return by reference the ground dictionary for simulation action purposes
    double combined_probability; // dummy unused value
    return isActionApplicable(action_name, params, true, false, false, ground_dictionary, combined_probability);
}
            ...
            std::map<std::string, std::string> &ground_dictionary)
{
    ...
    // and return by reference the ground dictionary for simulation action purposes
    double combined_probability; // dummy unused value
    return isActionApplicable(action_name, params, false, true, true, ground_dictionary, combined_probability);
}
...
bool ActionSimulator::simulateAction(std::string &action_name, std::vector<std::string> &params, bool action_start)
{
    ...
    if(action_start) {
        ...
        if(!isActionStartApplicable(action_name, params, ground_dictionary)) {
            ...
            ROS_INFO(isActionStartApplicable(action_name, params, ground_dictionary) ? "**true":"**false");
            double action_probability;
            ROS_INFO(isActionStartApplicable(action_name, params, action_probability) ? "**true":"**false");
            return false;
        }
    }
    else {
